...
public class ClearspaceUserProvider implements UserProvider {
    ...
    public Collection<User> findUsers(Set<String> fields, String query, int startIndex, int numResults) throws UnsupportedOperationException {
        ...
        queryE.addElement("searchName").addText("true");
        queryE.addElement("searchEmail").addText("true");
        queryE.addElement("searchPlate").addText("true");
        queryE.addElement("searchProfile").addText("false");
    ...
    private User translate(Node responseNode) {
        ...
        // Gets the plate
        tmpNode = userNode.selectSingleNode("plate");
        if (tmpNode != null) {
            plate = tmpNode.getText();
        }
        ...
        // Creates the user
        User user = new User(username, name, email, plate, creationDate, modificationDate);
	...
	public User createUser(String username, String password, String name,
        ...
        try {
            ...
            // adds the the email
            Element plateE = userE.addElement("plate");
            plateE.addText(plate);
        ...
        return new User(username, name, email, plate, new Date(), new Date());
	}
	...
	public void setPlate(String username, String plate)
        ...
        try {
            ...
            Element userUpdateParams = getUserUpdateParams(username);
            // Modifies the attribute of the user
            String[] path = new String[]{"user", "plate"};
            WSUtils.modifyElementText(userUpdateParams, path, plate);
            // Updates the user
            updateUser(userUpdateParams);
        } catch (UserNotFoundException e) {
            throw e;
