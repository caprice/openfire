...
public class DefaultUserProvider implements UserProvider {
    ...
    private static final String LOAD_USER =
            "SELECT name, email, creationDate, modificationDate, plate FROM ofUser WHERE username=?";
    ...
    private static final String INSERT_USER =
            "INSERT INTO ofUser (username,plainPassword,encryptedPassword,name,email,creationDate,modificationDate,plate) " +
            "VALUES (?,?,?,?,?,?,?,?)";
    ...
    private static final String UPDATE_PLATE =
            "UPDATE ofUser SET plate=? WHERE username=?";
    ...
    public User loadUser(String username) throws UserNotFoundException {
        ...
        try {
            ...
            return new User(username, name, email, plate, creationDate, modificationDate);
        }
        catch (Exception e) {
	...
	public User createUser(String username, String password, String name,
			String email, String plate) throws UserAlreadyExistsException {
	       try {
	            loadUser(username);
	            // The user already exists since no exception, so:
	            throw new UserAlreadyExistsException("Username " + username + " already exists");
	            ...
	            return new User(username, name, email, plate, now, now);
	        }
	}

	@Override
	public void setPlate(String username, String plate)
