...
public class UserManager implements IQResultListener {
            ...
            throws UserAlreadyExistsException
    {
        ...
        if (provider.isPlateRequired()) {
            throw new IllegalArgumentException("Invalid or empty plate address specified with provider that requires plate. User: "
                                                + username + " plate: " + plate);
        }
        User user = provider.createUser(username, password, name, email, plate);
