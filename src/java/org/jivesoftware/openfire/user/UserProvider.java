...
public interface UserProvider {
     ...
     * @param name the user's name, which can be <tt>null</tt>, unless isNameRequired is set to true.
     * @return a new User.
     * @param plate the user's plate , which can be <tt>null</tt>, unless isPlateRequired is set to true.
     * @throws UserAlreadyExistsException if the username is already in use.
     */
    public User createUser(String username, String password, String name, String email, String plate)
            throws UserAlreadyExistsException;
    /**
    ...
    /**
     * Sets the user's plate. This method should throw an
     * UnsupportedOperationException if this operation is not supported
     * by the backend user store.
     *
     * @param username the username.
     ...
     * @throws UserNotFoundException if the user could not be found.
     */
    public void setPlate(String username, String plate) throws UserNotFoundException;
     ...
     * Returns true if this UserProvider requires an email address to be set on User objects.
     *
     * @return true if an plate is required with this provider.
     */
