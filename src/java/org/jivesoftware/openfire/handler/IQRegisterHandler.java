...
public class IQRegisterHandler extends IQHandler implements ServerFeaturesProvider {
	...
	public void initialize(XMPPServer server) {
        ...
        if (probeResult == null) {
            ...
            final FormField fieldPlate = registrationForm.addField();
            fieldPlate.setVariable("plate");
            fieldPlate.setType(FormField.Type.text_single);
            fieldPlate.setLabel("Plate");
            if (UserManager.getUserProvider().isPlateRequired()) {
            	fieldPlate.setRequired(true);
            }
            ...
            if (!registrationEnabled) {
                ...
                if (session.getStatus() == Session.STATUS_AUTHENTICATED) {
                    try {
                        ...
                        currentRegistration.element("plate").setText(user.getPlate());
                        ...
                        while (fields.hasNext()) {
                            ...
                            else if ("plate".equals(field.attributeValue("var"))) {
                                field.addElement("value")
                                        .addText(user.getPlate() == null ? "" : user.getPlate());
                            }
                        }
            ...
            try {
                ...
                if (iqElement.element("remove") != null) {
                    ...
                    if (formElement != null) {
                        ...
                        // Get the plate sent in the form
                        field = registrationForm.getField("plate");
                        if (field != null) {
                            values = field.getValues();
                            name = (!values.isEmpty() ? values.get(0) : " ");
                        }
                        ...
                        plate = iqElement.elementText("plate");
                    }
                    ...
                    if (session.getStatus() == Session.STATUS_AUTHENTICATED) {
                        ...
                        // If inband registration is not allowed, return an error.
                            ...
                            if (user.getUsername().equalsIgnoreCase(username)) {
                                ...
                                newUser = userManager.createUser(username, password, null, email, plate);
                            }
                            else {
                        ...
                        // information was not provided
                            ...
                            newUser = userManager.createUser(username, password, name, email, plate);
                        }
                    }
